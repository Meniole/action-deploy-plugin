...
## [1.4.0](https://github.com/Meniole/action-deploy-plugin/compare/v1.3.3...v1.4.0) (2026-04-10)
...
* add short_name to manifest in action.yml ([48a04b5](https://github.com/Meniole/action-deploy-plugin/commit/48a04b59cd97476856b89b641d9d0a1992d98b40))
* add single-file bundling option ([aafef9a](https://github.com/Meniole/action-deploy-plugin/commit/aafef9aaaf2307830a6a45e95235574ab99c42a3))
* derive manifest metadata from plugin entrypoint contract ([8f71e7d](https://github.com/Meniole/action-deploy-plugin/commit/8f71e7dd4710324537021fbb6e78ddb4ddb4c57b))
* esm + cjs ([f643ab7](https://github.com/Meniole/action-deploy-plugin/commit/f643ab79f90d858773676722e270cc6f74e4bb81))
* extract listeners from SupportedEvents type and add local testing mode ([e4b835d](https://github.com/Meniole/action-deploy-plugin/commit/e4b835d35396ecb6485a906059dde4a18d5f1c2a))
* generate manifest metadata from code exports and package.json ([4eca529](https://github.com/Meniole/action-deploy-plugin/commit/4eca5299f3e7d2e52fe2e02de10342c32a73b406))
* generate manifest metadata from code exports and package.json ([40cb3a2](https://github.com/Meniole/action-deploy-plugin/commit/40cb3a2568eabbfca8a25f543dcd910df363651e)), closes [#27](https://github.com/Meniole/action-deploy-plugin/issues/27)
* publish generated outputs to artifact branches ([507ada6](https://github.com/Meniole/action-deploy-plugin/commit/507ada6b9a59620bd100b79ac09b186104e115de))
* publish generated outputs to artifact branches (issue [#320](https://github.com/Meniole/action-deploy-plugin/issues/320)) ([4fde24c](https://github.com/Meniole/action-deploy-plugin/commit/4fde24c3d4ecd2e356dd977158c1b40b7862c95c))
* set skipBotEvents from action input ([1112ffc](https://github.com/Meniole/action-deploy-plugin/commit/1112ffc8fc099c8386b5b8cb24399d4811fc68b4))


### Bug Fixes

* **action:** default sourceRef for delete events ([126c3d4](https://github.com/Meniole/action-deploy-plugin/commit/126c3d4015c9be86532b25412a492b3041dc648e))
* **action:** make sourceRef default delete-aware ([d2457d8](https://github.com/Meniole/action-deploy-plugin/commit/d2457d8359d9520badafda4998d36eee6255b3c9))
...
* address latest review comments ([8231e4e](https://github.com/Meniole/action-deploy-plugin/commit/8231e4e5ba3ca958edc662ab62ced7df25b8d3fb))
* address PR review feedback ([22c38e1](https://github.com/Meniole/action-deploy-plugin/commit/22c38e1e4b6c24dc0801e8a11aa7258cddd0c08e))
* **artifact:** include action metadata in dist branch payload ([5536f46](https://github.com/Meniole/action-deploy-plugin/commit/5536f46f2e52ebffed2a17587da5891b51cde569))
* **artifact:** include compute workflow in dist payload ([21d41e4](https://github.com/Meniole/action-deploy-plugin/commit/21d41e4b03df78204810e05af846e8c6c6707c98))
* **artifact:** include compute workflow in dist payload ([3ac390b](https://github.com/Meniole/action-deploy-plugin/commit/3ac390b10610e51946c1bad92aa775b1c7456c51))
* **artifact:** include package and lock files in dist payload ([f8fe978](https://github.com/Meniole/action-deploy-plugin/commit/f8fe97894eee26e02d39209e619584bc43fc7caf))
* **artifact:** include package and lock files in dist payload ([987beaa](https://github.com/Meniole/action-deploy-plugin/commit/987beaabe2ede2a60ead18cc4e9814e6fbafb695))
* **artifact:** publish dist index.cjs entrypoint ([fe114c0](https://github.com/Meniole/action-deploy-plugin/commit/fe114c037749c9cf925fa713b56ac8ad35f04eaf))
...
* **ci:** avoid heredoc parsing in CJS bridge generation ([5073aaf](https://github.com/Meniole/action-deploy-plugin/commit/5073aafb31a4635ad6e95d3b034611ba7b152f16))
* **ci:** preserve skipBotEvents during publish ([f9906e5](https://github.com/Meniole/action-deploy-plugin/commit/f9906e5c9ea6eef74ea3273bafcfc967d633a0e2))
* **ci:** reapply manifest before artifact publish ([0412531](https://github.com/Meniole/action-deploy-plugin/commit/0412531be761f384f1328e8a0a8f4ea332299a06))
* **ci:** reapply manifest before artifact publish ([75fc321](https://github.com/Meniole/action-deploy-plugin/commit/75fc3213ad57609f79d536042c07786f5fca79ab))
* **ci:** stabilize manifest publishing in composite action ([d394426](https://github.com/Meniole/action-deploy-plugin/commit/d394426ac55907c74e0e61943103a978e3595a42))
* **ci:** stabilize manifest publishing in composite action ([d546c0b](https://github.com/Meniole/action-deploy-plugin/commit/d546c0b5a0bc1e98996788bd2277c4cc3600e6a6))
* **ci:** use npm install in tests workflow ([a67fda0](https://github.com/Meniole/action-deploy-plugin/commit/a67fda0bdb670ac092b9d8d1748b70863ef0e632))
...
* ensure node imports have proper prefixes ([ab0874b](https://github.com/Meniole/action-deploy-plugin/commit/ab0874ba7bc3ed90042fc738fabd882eec0ad02a))
* finalize manifest after build to preserve skipBotEvents ([04f39f3](https://github.com/Meniole/action-deploy-plugin/commit/04f39f3be66cb242be9c5145716daab80b4be834))
* fixed ESM packge.json ([16f8202](https://github.com/Meniole/action-deploy-plugin/commit/16f82026932cc7fe8d2e81b5f822b2400a757e7b))
* generate manifest before build in publish flow ([6b9e65e](https://github.com/Meniole/action-deploy-plugin/commit/6b9e65e04f6461235d38ae7d90575b55e8465c11))
* generate manifest metadata from source TypeScript schemas ([1a761af](https://github.com/Meniole/action-deploy-plugin/commit/1a761af6d970ba35f1e3e10f5cab82a623f7ced9))
...
* include action.yml in artifact branch payload ([9d3c21c](https://github.com/Meniole/action-deploy-plugin/commit/9d3c21ce64407f0d4cddb6a6d49857fff3e6dda5))
* keep artifact branch tree scoped to generated files ([9e89cff](https://github.com/Meniole/action-deploy-plugin/commit/9e89cffa5d7ff10fa69e85e4860af8085b77a7c7))
* large files get committed properly ([092a224](https://github.com/Meniole/action-deploy-plugin/commit/092a2244991c4d04639d545a8fe3ef0ff7f8529e))
* make artifact branch delete idempotent when branch is missing ([effd880](https://github.com/Meniole/action-deploy-plugin/commit/effd880fb48994e0049d53362fa13cb631ec6b17))
* **manifest:** convert single-object command schemas ([#32](https://github.com/Meniole/action-deploy-plugin/issues/32)) ([75c41e9](https://github.com/Meniole/action-deploy-plugin/commit/75c41e96fb31efa010caaaf8b6c90c4b602631d6))
* propagate skipBotEvents to install/build env ([c40abcd](https://github.com/Meniole/action-deploy-plugin/commit/c40abcd771bc22e197d55820d90cc9f6587ef305))
...
* remove glob dependency from manifest updater ([260d50c](https://github.com/Meniole/action-deploy-plugin/commit/260d50cdf01f96a1cc24aed1ee24b395a179ff75))
...
* skip dist and tag refs in composite action ([#38](https://github.com/Meniole/action-deploy-plugin/issues/38)) ([559de1c](https://github.com/Meniole/action-deploy-plugin/commit/559de1cab0630ca9f45cf3847715153fdba56268))
...
* update node imports in reassembly-esm.js ([cb34619](https://github.com/Meniole/action-deploy-plugin/commit/cb34619ef3c62e8b72d6ba19f2b28db3303dc08e))
...
* warn instead of failing when artifact branch is missing ([8066946](https://github.com/Meniole/action-deploy-plugin/commit/8066946a5938b0149ee1fa300861d7fa919f824f))
